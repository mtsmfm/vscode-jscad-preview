...
<head>
	...
	<meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src data: ${cspSource}; script-src 'nonce-${nonce}' 'unsafe-eval'; style-src ${cspSource} 'nonce-${nonce}'; connect-src https:;">
